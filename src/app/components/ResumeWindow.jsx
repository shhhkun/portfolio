          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  <li className="mb-2">
                    Built reusable UI components and dashboard analytics
                    features in <strong>TypeScript</strong> within a large-scale
                    monorepo, integrating <strong>REST APIs</strong> to surface
                  ...
                  <li className="mb-2">
                    ...
                    <strong>PostgreSQL</strong>-backed features to align
                    frontend and data layers.
                  </li>
                  <li className="mb-2">
              ...
              <div>
                ...
                >
                  ...
                  <li className="mb-2">
                    Provided live technical support and assisted with
                    sponsorship outreach to support event growth.
                  </li>
                </ul>
              </div>
            </div>
