              ...
              <div>
                ...
                >
                  ...
                  <li className="mb-2">
                    ...
                    across <strong>4 platform services</strong>, developing
                    Clerk and APISIX proof-of-concepts while defining token,
                    session, and RBAC workflows.
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <li className="mb-2">
                    ...
                    day-of technical operations for the SlugCon anime
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <li className="mb-2">
                    ...
                    and transcripts to improve available evidence, achieving{" "}
                    <strong>98.3% Recall@3</strong> and{" "}
              ...
              <div>
                ...
                >
                  ...
                  <li className="mb-2">
                    Built a dynamic interface that extracted album artwork
                    colors to theme the application based on user listening
                    history.
                  </li>
                </ul>
              </div>
            ...
            >
              ...
              >
                ...
                <li className="mb-2">
                  ...
                  React, Next.js, FastAPI, Node.js, Express.js, PyTorch,
                  pgvector
                </li>
                <li className="mb-2">
                  <span className="font-bold" style={{ color: "var(--text)" }}>
