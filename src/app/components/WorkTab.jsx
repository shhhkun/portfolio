            ...
            >
              ...
              <div className="project-details flex w-full flex-col justify-between p-6">
                <div>
                  ...
                  <p className="flex-grow">
                    IoT smart mirror and companion mobile app connected through
                    a Python <strong>BLE</strong> pipeline, with{" "}
                    <strong>16 custom GATT characteristics</strong>{" "}
                    synchronizing configuration controls between a Raspberry Pi
                    and React Native client.
                  </p>
                </div>
                <div className="mt-4">
                  <p
