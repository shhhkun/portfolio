            ...
            <div style={{ fontSize: "1rem" }}>
              ...
              >
                <li className="mb-2">
                  ...
                  for arbitrary URLs, extracting case metadata and assembling
                  evidence from CourtListener, Wikipedia, and semantic search to
                  generate case overviews with gpt-oss-120b.
                </li>
                <li className="mb-2">
